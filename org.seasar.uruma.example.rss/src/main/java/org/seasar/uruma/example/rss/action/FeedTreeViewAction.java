...
public class FeedTreeViewAction {
    ...
    // MessageDialog.openInformation(null, "メニュー６",
    // "メニュー６クリック！！"+obj.getClass().getSimpleName());
    // }
    //	
    // @EventListener(id = "menu7", type = EventListenerType.SELECTION)
    // public void doMenu7(final Object obj) {
    // MessageDialog.openInformation(null, "メニュー７",
    // "メニュー７クリック！！"+obj.getClass().getSimpleName());
    // }
    // @EventListener(id = "menu8", type = EventListenerType.SELECTION)
    // public void doMenu8(final Object obj) {
    // MessageDialog.openInformation(null, "メニュー８",
    // "メニュー８クリック！！"+obj.getClass().getSimpleName());
    // }
