...
echo eclipse 3.3 関連の依存ライブラリを maven リポジトリへアップロードするためのバッチ
...
%MVN% %GROUPID% %VER% -DartifactId=ui-workbench %ECLIPSE%org.eclipse.ui.workbench_3.3.0.I20070608-1100.jar
%MVN% %GROUPID% %VER% -DartifactId=ui %ECLIPSE%org.eclipse.ui_3.3.0.I20070614-0800.jar
%MVN% %GROUPID% %VER% -DartifactId=ui-texteditor %ECLIPSE%org.eclipse.ui.workbench.texteditor_3.3.0.v20070606-0010.jar
...
%MVN% %GROUPID% %VER% -DartifactId=core-filebuffers %ECLIPSE%org.eclipse.core.filebuffers_3.3.0.v20070606-0010.jar
%MVN% %GROUPID% %VER% -DartifactId=core-jobs %ECLIPSE%org.eclipse.core.jobs_3.3.0.v20070423.jar
...
%MVN% %GROUPID% %VER% -DartifactId=debug-core %ECLIPSE%org.eclipse.debug.core_3.3.0.v20070607-1800.jar
...
%MVN% %GROUPID% %VER% -DartifactId=equinox-registry %ECLIPSE%org.eclipse.equinox.registry_3.3.0.v20070522.jar
%MVN% %GROUPID% %VER% -DartifactId=jdt-core %ECLIPSE%org.eclipse.jdt.core_3.3.0.v_771.jar
%MVN% %GROUPID% %VER% -DartifactId=jdt-launching %ECLIPSE%org.eclipse.jdt.launching_3.3.0.v20070510.jar
%MVN% %GROUPID% %VER% -DartifactId=jface %ECLIPSE%org.eclipse.jface_3.3.0.I20070606-0010.jar
%MVN% %GROUPID% %VER% -DartifactId=osgi %ECLIPSE%org.eclipse.osgi_3.3.0.v20070530.jar
%MVN% %GROUPID% %VER% -DartifactId=swt %ECLIPSE%org.eclipse.swt_3.3.0.v3346.jar
%MVN% %GROUPID% %VER% -DartifactId=swt-win32-win32-x86 %ECLIPSE%org.eclipse.swt.win32.win32.x86_3.3.0.v3346.jar
