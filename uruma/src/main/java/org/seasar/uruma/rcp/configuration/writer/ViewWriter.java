...
/**
 * <code>view</code> 要素のための {@link ConfigurationWriter} です。<br />
 * 
 * @author y-komori
 */
public class ViewWriter extends AbstractConfigurationWriter<ViewPartComponent> {

    /*
     * @see org.seasar.uruma.rcp.configuration.writer.AbstractConfigurationWriter#doGetSupportType()
     */
    @Override
    public Class<ViewPartComponent> doGetSupportType() {
        return ViewPartComponent.class;
    }
     ...
     */
    @Override
    public void doWriteStartTag(final ViewPartComponent element,
            final Writer writer) throws IOException {
        writer
                .write("<view class=\"" + GenericViewPart.class.getName()
                        + "\" ");
        writer.write("id=\"" + element.getRcpId() + "\" ");
        writer.write("name=\"" + element.title + "\" ");
        writer.write("allowMultiple=\"" + element.allowMultiple + "\" />\n");
    }
     ...
     */
    @Override
    public void doWriteEndTag(final ViewPartComponent element,
            final Writer writer) throws IOException {
        // Do nothing.
    }
}
