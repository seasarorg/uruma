...
/**
 * <code>tagName</code> 要素のためのタグハンドラです。<br />
 * 
 * @author y-komori
 */
public class TagNameTagHandler extends TagHandler {

    private static final long serialVersionUID = 2159173767929928622L;
