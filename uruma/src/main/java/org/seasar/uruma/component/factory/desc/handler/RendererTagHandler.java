...
/**
 * <code>renderer</code> 要素のためのタグハンドラです。<br />
 * 
 * @author y-komori
 */
public class RendererTagHandler extends TagHandler {

    private static final long serialVersionUID = -4694564739459978541L;
    ...
    public void start(final TagHandlerContext context,
        ...
        desc.setRendererClass(attributes.getValue("class"));
    }
}
