...
/**
 * Logicクラス用の {@link ComponentCreator}です。
 * <P>
 ...
 * <tr>
 * <th>サフィックス</th>
 * <td>{@link NamingConvention#getLogicSuffix() Logic(デフォルト)}</td>
 * </tr>
 * <tr>
 * <th>インスタンス定義</th>
 * <td>SINGLETON</td>
 ...
 * 
 */
public class UrumaLogicCreator extends ComponentCreatorImpl {
     ...
     */
    public UrumaLogicCreator(final NamingConvention namingConvention) {
     ...
     *            コンポーネントカスタマイザ
     */
    public void setLogicCustomizer(final ComponentCustomizer customizer) {
