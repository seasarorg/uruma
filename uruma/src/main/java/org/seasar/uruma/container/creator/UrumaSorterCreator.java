...
/**
 * Sorterクラス用の {@link ComponentCreator}です。
 * <p>
 ...
 * 
 */
public class UrumaSorterCreator extends ComponentCreatorImpl {

    /**
     * 指定された{@link NamingConvention 命名規約}に従った{@link UrumaSorterCreator}を作成します。
     * 
     * @param namingConvention
     *            命名規約
     */
    public UrumaSorterCreator(final NamingConvention namingConvention) {
        super(namingConvention);
        setNameSuffix("Sorter");
