...
import org.seasar.uruma.binding.method.GenericSWTSelectionListener;
...
/**
 * {@link UrumaTreeViewer} のための {@link ListenerBinder} です。<br />
 * 
 * @author y-komori
 */
public class UrumaTreeViewerListenerBinder extends AbstractListenerBinder {
    ...
    public void bindListener(final WidgetHandle handle,
        ...
        SelectionListener listener = new GenericSWTSelectionListener(context,
                binding);
